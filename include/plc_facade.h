/**
 * @file plc_facade.h
 * @brief Interface for creating PLC messages to control train-related components
 ...
 * @param[in] railId Identifier of the powered rail (from the PoweredRailId_e enum)
 ...
 * @param[out] msg Pointer to the PlcMessage_t structure to populate
 * @param[in] trainId Identifier of the train (from the TrainId_e enum)
 * @param[in] railId Identifier of the reversible rail (from the InversibleRailId_e enum)
 * @return 0 on success, non-zero error code on failure
 */
