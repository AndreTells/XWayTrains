...
run/resource_manager: build/resource_manager
	./build/resource_manager -ip 127.0.0.1

run/train_manager1: build/train_manager
	./build/train_manager --route1 route/train1.route --route2 route/train2.route --xway1 40 --xway2 41

run/train_manager2: build/train_manager
	./build/train_manager --route1 route/train3.route --route2 route/train4.route --xway1 42 --xway2 43
